...
namespace QuickApp.SQLDAL.Models
{
    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public DatabaseInitializer(QuickappContext context, IAccountManager accountManager, ILogger<DatabaseInitializer> logger)
        {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Users.AnyAsync())
            {
                ...
                await CreateUserAsync("superadmin", "Superadmin@123", "Inbuilt Administrator", "superadmin@gmail.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("superuser", "Superuser@ss123", "Inbuilt Standard User", "superuser@gmail.com", "+1 (123) 000-0001", new string[] { userRoleName });
